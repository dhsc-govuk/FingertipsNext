...
const SearchIcon = ()=>{
  return(
  <svg viewBox="0 0 57 57"  width="15" height="15" fill='#75738c' style={{padding:"0px", margin:"auto 10px auto auto"}}>
    <path d="M55.146,51.887L41.588,37.786c3.486-4.144,5.396-9.358,5.396-14.786c0-12.682-10.318-23-23-23s-23,10.318-23,
