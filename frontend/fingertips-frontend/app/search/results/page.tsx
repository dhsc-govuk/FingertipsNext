...
export default async function Page(
  ...
  try {
    ...
    // Log error response
    // TBC
    console.log(`Error response received from call to Search service: ${error}`);
    return <ErrorPage errorText='An error has been returned by the search service. Please try again.' errorLink='/search' errorLinkText='Return to Search' />;
  }
}
