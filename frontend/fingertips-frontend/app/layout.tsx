...
import OneIndicatorOneAreaView from '@/components/views/OneIndicatorOneAreaView';
      ...
      <body className={gdsTransportFont.className} style={{ margin: 0 }}>
        <StyledComponentsRegistry>
          ...
          <FTContainer>
            ...
            <OneIndicatorOneAreaViewPlots indicatorData={testHealthData}  searchState={searchState} indicatorMetadata={mockMetaData}/>
          </FTContainer>
          <FTFooter />
        </StyledComponentsRegistry>
      </body>
