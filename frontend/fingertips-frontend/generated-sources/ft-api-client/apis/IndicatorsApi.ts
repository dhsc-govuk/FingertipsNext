  ...
  implements IndicatorsApiInterface
{
  ...
  async getHealthDataForAnIndicatorRaw(
    ...
    console.log(
      `JH GETHEALTHDATA [${uuid}] REQ HEADERS: [${JSON.stringify(headerParameters)}]`
    );
    console.log(
      `JH GETHEALTHDATA [${uuid}] REQ OVERRIDES: [${JSON.stringify(initOverrides)}]`
    );
    const response = await this.request(
      {
  ...
  async indicatorsIndicatorIdDataPostRaw(
    ...
    const uuid = randomUUID();
    console.log(
      `JH UPLOAD [${uuid}] REQ HEADERS: [${JSON.stringify(headerParameters)}]`
    );
    console.log(
      `JH UPLOAD [${uuid}] REQ OVERRIDE: [${JSON.stringify(initOverrides)}]`
    );
