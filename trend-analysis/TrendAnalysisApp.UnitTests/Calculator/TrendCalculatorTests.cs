...
public class TrendCalculatorTests
{
    ...
    public void TestIdentifierWithNonSupportedValueTypeReturnsNoTrend() {
        ...
        result.ShouldBe(Trend.CannotBeCalculatedValueType);
        result.ToString().ShouldBe("CannotBeCalculatedValueType");
    }
    ...
    public void TestTrendCannotBeCalculatedWhenInsufficientDataPointsProvided() {
        ...
        result.ShouldBe(Trend.CannotBeCalculatedDataPoints);
        result.ToString().ShouldBe("CannotBeCalculatedDataPoints");
    }
}
