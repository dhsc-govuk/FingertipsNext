...
public class AutoMapperProfiles : Profile
{
    public AutoMapperProfiles()
    {
        CreateMap<AreaTypeModel, AreaType>()
            .ForMember(dest => dest.AreaTypeKey, opt => opt.MapFrom(src => src.AreaTypeKey))
        ...
        CreateMap<AreaWithRelationsModel, AreaWithRelations>()
            ...
            .ForMember(dest => dest.HierarchyName, opt => opt.MapFrom(src => src.Area.AreaType.HierarchyType))
            .ForMember(dest => dest.AreaType, opt => opt.MapFrom(src => src.Area.AreaType.AreaTypeName))
            .ForMember(dest => dest.Level, opt => opt.MapFrom(src => src.Area.AreaType.Level))
        ...
        CreateMap<AreaModel, Schemas.Area>()
            ...
            .ForMember(dest => dest.AreaType, opt => opt.MapFrom(src => src.AreaType.AreaTypeName))
            .ForMember(dest => dest.Level, opt => opt.MapFrom(src => src.AreaType.Level))
            .ForMember(dest => dest.HierarchyName, opt => opt.MapFrom(src => src.AreaType.HierarchyType));
