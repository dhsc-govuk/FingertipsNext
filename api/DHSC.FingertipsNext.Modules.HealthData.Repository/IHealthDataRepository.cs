...
public interface IHealthDataRepository
{
    ...
    Task<IEnumerable<QuartileDataModel>> GetQuartileDataAsync(IEnumerable<int> indicatorIds, string areaCode, string areaTypeKey, string areaGroup, string benchmarkAreaCode);
