...
{
    private static readonly IndicatorWithHealthDataForArea SampleHealthData = new IndicatorWithHealthDataForArea
    {
    ...
    public async Task GetIndicatorData_ReturnsNotFoundResponse_IfServiceReturnsEmptyArray()
    {
        _indicatorService
            .GetIndicatorDataAsync(Arg.Any<int>(), Arg.Any<string[]>(), Arg.Any<int[]>(), Arg.Any<string[]>())
            .Returns(null as IndicatorWithHealthDataForArea);
