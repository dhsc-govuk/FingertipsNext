...
public interface IIndicatorsService
{
    ...
    /// <param name="comparisonMethod">string eg Rag, Quartile</param>
    /// <returns></returns>
    /// <remarks>
    ...
    /// </remarks>
    Task<IEnumerable<HealthDataForArea>> GetIndicatorDataAsync(int indicatorId, string[] areaCodes, int[] years,
        string[] inequalities, string comparisonMethod);
}